        ...
        <nav class="megamenu navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('assets/img/u.png')); ?>" style="width: 100px;height: 50px;" alt="image"></a>
                </div>
    ...
    <div id="support" class="section db">
        <div class="container">
            <div class="text-center">
                <img src="<?php echo e(url('assets/img/u.png')); ?>" />
            </div>
